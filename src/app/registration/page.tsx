...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ic4.co.in/registration",
  },
};
                ...
                <tbody className="bg-card/50 backdrop-blur-sm">
                  {[
                    ...
                    >
                      ...
                      <td className="p-4 text-center font-mono text-primary line-through">
                        {row.usdReg}
                      </td>
                    </tr>
                  ))}
                  <tr className="bg-primary/5 font-semibold">
                    ...
                    <td
                      colSpan={4}
                      className="p-4 text-center text-lg text-primary line-through"
                    >
                      ₹ 1500
                    </td>
                  </tr>
