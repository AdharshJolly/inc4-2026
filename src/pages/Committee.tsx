  ...
  const committeeCategories = [
    {
      ...
      label: "Chief Patron",
      members: [
        { name: "Dr. Fr. Joseph C C", role: "Vice Chancellor", affiliation: "CHRIST (Deemed to be University)" },
      ]
    },
    {
      id: "patrons",
      label: "Patrons",
      members: [
        { name: "Dr. Fr. Viju P D", role: "Pro Vice Chancellor", affiliation: "CHRIST (Deemed to be University)" },
        { name: "Dr. Anil Joseph Pinto", role: "Registrar", affiliation: "CHRIST (Deemed to be University)" },
      ]
    },
    {
      id: "honorary-chairs",
    ...
    },
    {
      ...
      members: [
        { name: "Dr. Abhishek Appaji", role: "Chapter Vice-Chair", affiliation: "IEEE CS Bangalore" },
        { name: "Sunil Kumar Vuppala", role: "Chapter Vice-Chair", affiliation: "IEEE CS Bangalore" },
        { name: "Alok Ranjan", role: "Chapter Secretary", affiliation: "IEEE CS Bangalore" },
        { name: "Sourav Kanti Addya", role: "Chapter Joint Secretary", affiliation: "NITK Surathkal" },
        { name: "Chengappa MR", role: "Member", affiliation: "Hewlett Packard Enterprise" },
        { name: "Dilip Dalei", role: "Member", affiliation: "DRDO" },
        { name: "Rohit Verma", role: "Member", affiliation: "Intel" },
        { name: "Parkavi A.", role: "Member", affiliation: "Ramaiah Institute of Technology" },
      ]
    },
    {
      id: "tpc",
    ...
    },
    {
      ...
      members: [
         { name: "To be announced", role: "Advisor", affiliation: "IEEE Bangalore Section" }
      ]
    },
    {
      id: "publication",
    ...
    },
    {
      ...
      members: [
        { name: "To be announced", role: "Organizing Chair", affiliation: "CHRIST University" }
      ]
    },
    {
      id: "publicity",
    ...
    },
    {
      ...
      members: [
        { name: "To be announced", role: "Volunteer", affiliation: "CHRIST University" }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pb-20">
        <Tabs defaultValue="steering" className="space-y-12">
          ...
          {committeeCategories.map((category) => (
            <TabsContent key={category.id} value={category.id} className="animate-fade-in focus-visible:outline-none">
