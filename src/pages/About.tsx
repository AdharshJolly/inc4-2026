          ...
          <section className="space-y-6 animate-slide-up">
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed">
              <p>
                ...
                Contemporary Computing and Communications (InC4) organized by
                ...
                University), Kengeri Campus, Bengaluru, India and IEEE Student
                Branch, CHRIST University, Bangalore.
              </p>
              <p>
                Recent advancements in computing and communication attract
                people from academia and industry. It focuses on topics of
                contemporary interest to computer and computational scientists
                and engineers. The InC4 - 2026 will bring together researchers
                and practitioners from academia, industry, and government to
                deliberate upon contemporary computing and communication's
                algorithmic, systemic, applied, and educational aspects. The
                conference will witness multiple eminent keynote speakers from
                academia and industry worldwide and the presentation of accepted
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-foreground/80">
                    Received 780 research articles from 18 countries. A total of
                    162 papers were presented during the conference.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-foreground/80">
                    Received 680 research articles from 16 countries. After a
                    rigorous review process with the help of program committee
                    members and more than 500 reviewers, 170 papers were
          ...
          >
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed">
              <p>
                ...
                of Mary Immaculate (CMI), in 1831, which administers CHRIST
              ...
              <p>
                ...
                adoption of global higher education practices with the support
              ...
              <p>
                ...
                Institution with Potential for Excellence in 2006. In 2008 under
                Section 3 of the UGC Act, 1956, the Ministry of Human Resource
                Development of the Government of India declared the institution
                a Deemed to be University, in the name and style of Christ
                University. One of the first institutions in India to be
                accredited in 1998 by the NAAC, and subsequently in 2004 and
                2016, CHRIST (Deemed to be University) has the top grade 'A' in
                the 4-point scale.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed">
              <p>
                ...
                in computer science and engineering, focusing on the regions of
                the state of Karnataka, India. IEEE Computer Society Bangalore
                Chapter, founded in the year 1982, is one of the largest
                technical societies of IEEE Bangalore.
              </p>
            </div>
          </section>
        </div>
