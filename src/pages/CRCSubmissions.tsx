          ...
          >
            <CardContent className="p-8">
              <ol className="space-y-4 text-muted-foreground list-decimal list-inside marker:text-primary marker:font-bold">
                <li>
                  Prepare your Camera-Ready Paper as per the "Instruction to
                  prepare Camera Ready Paper."
                </li>
                <li>
                  Prepare reply to reviewers as per the instructions
                  (Instruction to prepare reply to reviewers).
                </li>
                <li>
                  Deposit Registration fee. Visit{" "}
                  <a
                    href="/registration"
                ...
                <li>
                  Upload all the documents (carefully go through Instruction to
                  submit final files) through Microsoft CMT under Author Console
                  using link{" "}
                ...
                <li>
                  After Registration, please submit your information through{" "}
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-muted-foreground pl-10 list-disc">
                <li>
                  Authors are advised to strictly follow an IEEE template for
                  the paper available on the conference website.{" "}
                  <a href="#" className="text-primary hover:underline">
                ...
                <li>
                  For best results, please copy and paste your content into IEEE
                  template and apply the appropriate style.
                </li>
                <li>
                  Please do not change header, footer, and other formatting of
                  template.
                </li>
                <li>
                  Before formatting please carefully go through instructions
                  given in template, especially section III "PREPARE YOUR PAPER
                  BEFORE STYLING."
                </li>
                <li>
                  Paper length must be 4-6 pages in the IEEE template. Above 6
                  pages in the given IEEE Conference Format, need approval from
                  TPC.
                </li>
                <li>
                  Cite all the references in text. It is mandatory to discuss
                  the referred literature in the text.
                </li>
                <li>
                  Provide high-resolution images. Text in the image must be
                  readable.
                </li>
                <li>
                  Screenshots are not acceptable in the paper. Use proper images
                  downloaded from simulators or use some tools to draw images
                  (like draw.io).
                </li>
                <li>
                  Each figure must be captioned and must be discussed in the
                  text.
                </li>
                <li>
                ...
                <li>
                  Tables must be typed and captioned and must be discussed in
                  the text. Table in image format not acceptable.
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-muted-foreground pl-10 list-disc">
                ...
                <li>
                  Reply all the queries and highlight (in yellow color) action
                  in camera ready paper.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-muted-foreground pl-10 list-disc">
                <li>
                  Registration link will be enabled on Registration tab. Please
                  register in appropriate category
                </li>
                <li>Please note that registration fee is non-refundable.</li>
                <li>
                  Fee must be deposited by Explara. Link will be provided soon.
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-2 text-muted-foreground pl-10 list-disc">
                <li>
                  ...
                  <ul className="list-[circle] pl-6 mt-2 space-y-1">
                    ...
                    <li>
                      IEEE Membership proof (if registering in IEEE Member
                      category)
                    </li>
                  </ul>
                </li>
